package chipset.potato.prefrences;
...
public class Preferences {
    ...
    /*
     * Methods to s SharedPreferences data
	 */
    //Boolean
    ...
    public void putSharedPreference(Context context, String preferenceName,
        ...
        SharedPreferences.Editor editor = pref.edit();
        editor.clear();
        editor.putString(preferenceName, new Gson().toJson(val));
        editor.commit();
    }
    ...
    // Object
    public Object getSharedPreferenceObject(Context context, String preferenceName) {
        SharedPreferences pref = context
                .getSharedPreferences(preferenceName, 0); // 0 - for private
        // mode

        return new Gson().fromJson(pref.getString(preferenceName, null), Object.class);
